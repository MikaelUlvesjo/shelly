let CONFIG = {
    ...
    inUseLimit: -1.0, // nr of wats required to consider the controlled unit to be running and to not swith it of for non pm units set this to -1.0 
    updateTime: 900, // 3600 that is every hour, 900 is every 15 minutes. Price update interval in seconds
    ...
    checkNextXHours: 0, // check that the price do not go over the limit the next x hours if it is then switch off now,
    ...
    colorMode: false, // Set to true to change color on shelly plus plug s led from green to red based on price. Lowest price of the day will be green and heighest price of the day will be red and 
